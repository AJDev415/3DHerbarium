export default function Page() {
    return <div>
        ...
        <p>By accessing and using this website (the "Service"), you agree to be bound by these Terms and Conditions ("Terms"), all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these Terms, you are prohibited from using or accessing this site.</p>

        <h2>2. Privacy and Data Usage</h2>

        <h3>a. Account Registration Data</h3>
        <p>We collect and store the email address you provide for the sole purpose of creating and maintaining your user account and enabling your log-in access to the Service. We do not share, sell, or rent this personal data to third parties for marketing purposes.</p>

        <h3>b. Payment Processing and Cookies</h3>
        <p>All payment transactions are handled through a third-party payment processor, <strong>Stripe</strong>.</p>
        <ul>
            <li><strong>Payment Data:</strong> We do not directly store your credit card details. Stripe processes and stores this information securely.</li>
        ...
        <h2>3. User Content and 3D Model Submissions</h2>

        <h3>a. Definition of User Content</h3>
